      ...
      <main className="flex-grow">
        ...
        <div className="bg-blue-900 text-white py-16">
          <div className="container mx-auto px-4">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Where We Shine</h1>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="space-y-24 mb-16">
              ...
              <div id="kickoff" className="relative scroll-mt-24">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  ...
                  <div className="order-1 md:order-2">
                    <h3 className="text-2xl font-semibold mb-4">Project Kickoff Speed</h3>
                    <p className="text-lg mb-4">
              ...
              <div id="design" className="relative scroll-mt-24">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  <div>
                    <h3 className="text-2xl font-semibold mb-4">Design, Develop & Deploy</h3>
                    <p className="text-lg mb-4">
            ...
            <div className="bg-gray-50 p-8 rounded-lg text-center">
              <h3 className="text-2xl font-semibold mb-4">The Outcomes</h3>
              ...
              <div className="grid md:grid-cols-4 gap-6">
                ...
                <div>
                  ...
                  <div className="text-gray-600">Increased ROI</div>
                </div>
                <div>
